    		  ...
    		  <h3>帮助</h3>
		        <div class="accordion" id="accordion-help">
		            <div class="accordion-group">
		                ...
		                <div id="que1" class="accordion-body collapse">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="que2" class="accordion-body collapse">
                            <div class="accordion-inner">
目前系统没有做出限制，但是我们推荐每个群聊中不要超过五路电话，后续版本会增加容量，让更多的人可以参与到群聊中。
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="que3" class="accordion-body collapse">
                            <div class="accordion-inner">
每分钟0.2元人民币，一次群聊的总费用就是群聊中每路电话的通话时长之和乘以0.2元。
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="que4" class="accordion-body collapse">
                            <div class="accordion-inner">
...
或者联系客服咨询详情。
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="que5" class="accordion-body collapse">
                            <div class="accordion-inner">
