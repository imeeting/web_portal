    	...
    	<div class="row">
    		<div class="span4 offset4">
				<div class="page-header">
					<h2>每个群聊中最多可以有多少人同时对话？</h2>
				</div>
				<p>目前系统没有做出限制，但是我们推荐每个群聊中不要超过五路电话，后续版本会增加容量，让更多的人可以参与到群聊中。</p>
				<div class="page-header">
					<h2>使用电话呼入群聊是否免费？</h2>
				</div>
				<p>我们不对呼入的电话收取任何费用，但是用户需要向电信运营商缴纳正常的语音通话费用。</p>
				<div class="page-header">
					<h2>视频通话是否收费？</h2>
				</div>
				<p>视频同样免费，但是用户需要向电信运营商缴纳产生的流量费。</p>	
				<div class="page-header">
					<h2>我们的联系方式</h2>
				</div>
				<p>客服QQ：1622122511</p>
