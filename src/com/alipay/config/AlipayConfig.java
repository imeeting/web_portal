...
public class AlipayConfig {
	...
	// 必须保证其地址能够在互联网中访问的到
	public static String notify_url = "http://www.wetalking.net/imeeting/alipayComplete";
	...
	public static String return_url = "http://www.wetalking.net/imeeting/alipayReturn";
